...
const HARMONY_STRATEGIES = ['complement', 'analogous', 'tint', 'triad'];
const DEFAULT_HARMONY = 'complement';
 ...
 * @returns {string|null}
 */
function normalizeHarmonyHex(value, fallback = null) {
 ...
 */
function normalizeHarmonyStrategy(value) {
 ...
 */
function deriveHarmoniousColors(primaryHex, strategy = DEFAULT_HARMONY) {
 ...
 */
function fillHarmoniousSlots(primaryHex, existing = {}, strategy = DEFAULT_HARMONY, slots = {}) {
 ...
 * @returns {{ secondary: string|null, tertiary: string|null }}
 */
function matchColorsToPrimary(primaryHex, strategy = DEFAULT_HARMONY, slots = {}) {
