...
export default function SmartReportExecutiveTab({ snapshot, periodLabel }) {
  ...
  const kpiItems = [
    { label: 'Total Revenue', value: kpis.revenue.value, change: kpis.revenue.change, sparklineData: kpis.revenue.sparkline, icon: CircleDollarSign, iconBgColor: '#dcfce7', iconColor: '#166534', comparisonLabel },
    { label: 'Net Profit', value: kpis.netProfit.value, change: kpis.netProfit.change, sparklineData: kpis.netProfit.sparkline, icon: TrendingUp, iconBgColor: '#dcfce7', iconColor: '#166534', comparisonLabel },
    { label: 'Profit Margin', value: kpis.profitMargin.value, change: kpis.profitMargin.change, sparklineData: kpis.profitMargin.sparkline, valueFormatter: (v) => `${Number(v).toFixed(1)}%`, icon: Percent, iconBgColor: '#dcfce7', iconColor: '#166534', comparisonLabel },
    ...
    { label: 'Cash Flow', value: kpis.cashFlow.value, change: kpis.cashFlow.change, sparklineData: kpis.cashFlow.sparkline, icon: Wallet, iconBgColor: '#dcfce7', iconColor: '#166534', comparisonLabel },
  ];
