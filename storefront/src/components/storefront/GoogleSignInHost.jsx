...
/**
 * Initializes Google Identity Services once for the app and exposes
 * mountButton() for overlaying a real GIS button on custom UI.
 */
const GoogleSignInHost = ({ children }) => {
  const { googleClientId } = useStorefrontAuth();
